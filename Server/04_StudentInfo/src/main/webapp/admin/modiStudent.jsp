		...
		<div class="row"> 
			<div class="col-md-12">
				...
				<div class="row">
							...
							<div class="col-md-6">
								<h6>姓名</h6>
						<input type="text" name="sname" value="${student.sname }" class="form-control"  maxlength="4"></input>
						<h6>身份证号</h6>
						...
						<h6>密码</h6>
						<input type="password" name="spassword" value="${student.spassword }" class="form-control" maxlength="16"></input>
